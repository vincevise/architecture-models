...
loadModel('/residence.gltf', new THREE.Vector3(-45, -2, 65));
...
// camera.lookAt(-0.404, -0.020, 0.9145)
...
setCameraDirection(camera, new THREE.Vector3(-0.404, -0.020, 0.9145));
...
// Log camera position and direction when orbiting
